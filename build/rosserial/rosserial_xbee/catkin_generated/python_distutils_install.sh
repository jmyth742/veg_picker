...
echo_and_run cd "/home/jonny/veg_picker/src/rosserial/rosserial_xbee"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/jonny/veg_picker/src/rosserial/rosserial_xbee/setup.py" \
     \
    build --build-base "/home/jonny/veg_picker/build/rosserial/rosserial_xbee" \
    install \
    --root="${DESTDIR-/}" \
