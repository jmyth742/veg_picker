...
echo_and_run cd "/home/jonny/veg_picker/src/rosserial/rosserial_client"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/jonny/veg_picker/src/rosserial/rosserial_client/setup.py" \
     \
    build --build-base "/home/jonny/veg_picker/build/rosserial/rosserial_client" \
    install \
    --root="${DESTDIR-/}" \
