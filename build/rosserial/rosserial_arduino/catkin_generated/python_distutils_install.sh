...
echo_and_run cd "/home/jonny/veg_picker/src/rosserial/rosserial_arduino"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/jonny/veg_picker/src/rosserial/rosserial_arduino/setup.py" \
     \
    build --build-base "/home/jonny/veg_picker/build/rosserial/rosserial_arduino" \
    install \
    --root="${DESTDIR-/}" \
